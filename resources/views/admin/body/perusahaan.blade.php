				...
				<div class="table-responsive">
				  <table id="example1" class="table table-bordered table-striped">
					...
					<tr>
					  ...
					  <td nowrap>Reguler</td>
					  <td nowrap>Teknik Informatika</td>
					  <td nowrap>Teknologi Informasi</td>
					  <td nowrap>Ayahnya Alfiansyah</td>
					  <td nowrap>Ibunya Alfiansyah</td>
					  <td nowrap>+62 8123 56789</td>
					  <td nowrap>Kutai Kartanegara</td>
					  <td nowrap>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
				 ...
				 <form id="form_tambah" action="{{route('mahasiswa')}}" method="POST" >
				  <div class="box-body">
		...
		<div class="modal fade" id="hapus_mahasiwa_modal">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
				<form id="form_hapus" action="{{route('mahasiswa')}}" method="GET">
					{{ csrf_field() }}
					<button type="button" class="btn btn-default pull-left" data-dismiss="modal">BATAL</button>
